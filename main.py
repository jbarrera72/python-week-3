...
print(f"{name} liked to hum the song {song} while coding. It was so annoying that her teammates would throw {food} until {name} would stop singing.")
...
# The percentage of marks obtained by a student- mark_percent
# A variable to store the number of items in a shopping cart- items_cart


# Identify Valid and Invalid Names: Identify which of the following names are valid or invalid according to the rules:

# first_name- valid
# lastName- invalid (capitol letter)
# email_address- valid
# percentage- valid
# variable_name- valid
# 1_variable- invalid
